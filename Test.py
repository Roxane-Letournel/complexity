...
TOT=[TOTAL0]
C=['i', 'n', 't', 'h', 's', 'o', 'l', 'e', 'm', 'u', 'r', 'a', 'c', 'd', 'w', 'p', 'f', 'v', 'b', 'g', 'y', 'k', 'q', 'x', 'z', ';', 'nd', 'th', 'on', 'and', 'al', 'en', 'the', 'of', 'wh', 'is', 're', 'ou', 'our', 'or', 'no', 'not', 'at', 'in', 'ion', 'ation', 'that', 'this', 'be', 'bu', 'but', 'ing', 'bl', 'gh', 'igh', 'ight', 'an', 'it', 'whi', 'whic', 'which', 'for', 'who', 'ar', 'war', 'ay', 'abl', 'to']
for alpha in x[1:-1]:
    new_C,new_S_C,new_TOTAL=MDLChunker_search_factorized_distribution(all_stimuli,alpha)
    TOT.append(new_TOTAL)
    C.append(new_C)
    
y=[init/TOTAL0]+[init/TOT[i] for i in range(1,nb_points)]+[init/TOTAL1]
# In[109]: 
fig= plt.figure()
